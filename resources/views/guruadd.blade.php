      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="{{url('guru/store')}}" method="post">
                  {{csrf_field()}}
                  <div class="card-body row">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <input required type="text" name="nip" class="form-control" id="exampleInputEmail1" placeholder="Nomor Induk Kepegawaian">
                     </div>
                     <div class="form-group col-md-6">
