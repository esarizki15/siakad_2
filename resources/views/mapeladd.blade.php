      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="{{url('mata-pelajaran/save')}}" method="post">
                  {{csrf_field()}}
                  <div class="card-body row">
                     <div class="form-group col-md-2">
                        <label for="exampleInputEmail1">Kode</label>
                        <input required type="text" name="kode_mapel" class="form-control" id="exampleInputEmail1" placeholder="Kode">
                     </div>
                     <div class="form-group col-md-5">
                        <label for="exampleInputEmail1">Mata Pelajaran</label>
                        <input required type="text" name="nama_mapel" class="form-control" id="exampleInputEmail1" placeholder="Nama Pelajaran">
                     </div>
                     <div class="form-group col-md-5">
